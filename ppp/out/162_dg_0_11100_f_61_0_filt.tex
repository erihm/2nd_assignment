...
\input{\modInputPrefix/out/161_dg_0_11100_f_61_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-14-0)] (v-14-0) {$\mathrm{f\ 20,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-193-0)] (v-193-0) {$\mathrm{f\ 20,\ r_{2}}$};
% id = 196{ 'Fructose-6-Phosphate' 'p_{0,9}' }, 'Transketolase', { 'p_{0,17}' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-196-0)] (v-196-0) {$\mathrm{f\ 20,\ r_{2}}$};
% id = 216{ 'p_{0,6}' 'p_{0,16}' }, 'Transaldolase', { 'Fructose-6-Phosphate' 'p_{0,32}' }
\node[modStyleDGHyperEdge, at=(v-coord-216-0)] (v-216-0) {$\mathrm{f\ 20,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-339-0)] (v-339-0) {$\mathrm{f\ 20,\ r_{2}}$};
...
% id = 193{ 'p_{0,5}' 'p_{0,26}' }, 'Transketolase', { 'p_{0,0}' 'p_{0,20}' }
\path[modStyleDGHyperConnector] (v-11-0) to (v-193-0);
\path[modStyleDGHyperConnector] (v-95-0) to (v-193-0);
\path[modStyleDGHyperConnector] (v-193-0) to (v-2-0);
\path[modStyleDGHyperConnector] (v-193-0) to (v-63-0);
