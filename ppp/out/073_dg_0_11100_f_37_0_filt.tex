...
\input{\modInputPrefix/out/068_dg_0_11100_f_37_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-172-0)] (v-172-0) {$\mathrm{f\ 30,\ r_{2}}$};
% id = 183{ 'Ribulose-5-Phosphate' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,6}' }
\node[modStyleDGHyperEdge, at=(v-coord-183-0)] (v-183-0) {$\mathrm{f\ 30,\ r_{2}}$};
% id = 329{ 'Fructose-6-Phosphate' 'p_{0,31}' }, 'Transketolase', { 'p_{0,18}' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-329-0)] (v-329-0) {$\mathrm{f\ 30,\ r_{2}}$};
...
% inFlow/outFlow, id = 44-0, graphName = p_{0,17}, inFlow = 0, outFlow = 30
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-44-0-IOFlow)] (v-44-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-44-0) to node[auto, swap] {$\mathrm{f\ 30}$} (v-44-0-IOFlow);
% inFlow/outFlow, id = 68-0, graphName = Fructose-6-Phosphate, inFlow = 0, outFlow = 30
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-68-0-IOFlow)] (v-68-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-68-0) to node[auto, swap] {$\mathrm{f\ 30}$} (v-68-0-IOFlow);
\end{tikzpicture}%
