...
\input{\modInputPrefix/out/118_dg_0_11100_f_16_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-12-0)] (v-12-0) {$\mathrm{f\ 10,\ r_{2}}$};
% id = 40{ 'Ribulose-5-Phosphate' 'p_{0,4}' }, 'Transketolase', { 'p_{0,2}' 'p_{0,6}' }
\node[modStyleDGHyperEdge, at=(v-coord-40-0)] (v-40-0) {$\mathrm{f\ 10,\ r_{2}}$};
% id = 45{ 'p_{0,5}' 'p_{0,9}' }, 'Transketolase', { 'p_{0,0}' 'p_{0,17}' }
\node[modStyleDGHyperEdge, at=(v-coord-45-0)] (v-45-0) {$\mathrm{f\ 10,\ r_{2}}$};
