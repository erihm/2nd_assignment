...
\input{\modInputPrefix/out/157_dg_0_11100_f_60_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-6-0)] (v-6-0) {$\mathrm{f\ 10,\ r_{5}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-74-0)] (v-74-0) {$\mathrm{f\ 10,\ r_{3}}$};
% id = 90{ 'p_{0,6}' 'p_{0,7}' }, 'Aldolase', { 'p_{0,0}' }
\node[modStyleDGHyperEdge, at=(v-coord-90-0)] (v-90-0) {$\mathrm{f\ 10,\ r_{4}}$};
