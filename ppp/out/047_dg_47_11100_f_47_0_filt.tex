...
\node[modStyleDGHyperVertex, at=(v-coord-24-0)] (v-24-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/012_g_2_11311100.pdf}\\{$\mathrm{Fructose-6-Phosphate}$}};
...
\node[modStyleDGHyperEdge, at=(v-coord-23-0)] (v-23-0) {$\mathrm{f\ 25,\ r_{2}}$};
% id = 30{ 'Ribulose-5-Phosphate' 'p_{47,2}' }, 'Transaldolase', { 'Fructose-6-Phosphate' 'p_{47,4}' }
\node[modStyleDGHyperEdge, at=(v-coord-30-0)] (v-30-0) {$\mathrm{f\ 49,\ r_{3}}$};
% id = 52{ 'Ribulose-5-Phosphate' 'p_{47,9}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{47,2}' }
\node[modStyleDGHyperEdge, at=(v-coord-52-0)] (v-52-0) {$\mathrm{f\ 25,\ r_{2}}$};
...
\path[modStyleDGHyperConnector] (v-15-0) to node[auto, swap] {$\mathrm{f\ 25,\ r_{0}}$} (v-25-0);
...
% inFlow/outFlow, id = 5-0, graphName = p_{47,2}, inFlow = 0, outFlow = 1
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-5-0-IOFlow)] (v-5-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-5-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-5-0-IOFlow);
% inFlow/outFlow, id = 8-0, graphName = p_{47,4}, inFlow = 0, outFlow = 24
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-8-0-IOFlow)] (v-8-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-8-0) to node[auto, swap] {$\mathrm{f\ 24}$} (v-8-0-IOFlow);
...
\path[modStyleDGHyperConnector] (v-24-0) to node[auto, swap] {$\mathrm{f\ 74}$} (v-24-0-IOFlow);
\end{tikzpicture}%
