...
\input{\modInputPrefix/out/186_dg_0_11100_f_32_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-153-0)] (v-153-0) {$\mathrm{f\ 70,\ r_{2}}$};
% id = 182{ 'p_{0,8}' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-182-0)] (v-182-0) {$\mathrm{f\ 70,\ r_{2}}$};
% id = 196{ 'Fructose-6-Phosphate' 'p_{0,9}' }, 'Transketolase', { 'p_{0,17}' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-196-0)] (v-196-0) {$\mathrm{f\ 10,\ r_{2}}$};
% id = 200{ 'Fructose-6-Phosphate' 'p_{0,6}' }, 'Transketolase', { 'Ribulose-5-Phosphate' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-200-0)] (v-200-0) {$\mathrm{f\ 40,\ r_{2}}$};
