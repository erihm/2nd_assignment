...
\input{\modInputPrefix/out/106_dg_0_11100_f_13_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-153-0)] (v-153-0) {$\mathrm{f\ 40,\ r_{2}}$};
% id = 182{ 'p_{0,8}' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-182-0)] (v-182-0) {$\mathrm{f\ 40,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-256-0)] (v-256-0) {$\mathrm{f\ 10,\ r_{4}}$};
% id = 307{ 'H2O' 'p_{0,13}' }, 'Phophohydrolase', { 'p_{0,1}' 'p_{0,12}' }
\node[modStyleDGHyperEdge, at=(v-coord-307-0)] (v-307-0) {$\mathrm{f\ 10,\ r_{5}}$};
...
\path[modStyleDGHyperConnector] (v-44-0) to node[auto, swap] {$\mathrm{f\ 20,\ r_{0}}$} (v-58-0);
...
% id = 307{ 'H2O' 'p_{0,13}' }, 'Phophohydrolase', { 'p_{0,1}' 'p_{0,12}' }
\path[modStyleDGHyperConnector] (v-1-0) to (v-307-0);
\path[modStyleDGHyperConnector] (v-29-0) to (v-307-0);
\path[modStyleDGHyperConnector] (v-307-0) to (v-4-0);
\path[modStyleDGHyperConnector] (v-307-0) to (v-27-0);
