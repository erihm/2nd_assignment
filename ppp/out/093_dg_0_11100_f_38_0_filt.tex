...
\input{\modInputPrefix/out/076_dg_0_11100_f_38_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-109-0)] (v-109-0) {$\mathrm{f\ 20,\ r_{5}}$};
% id = 144{ 'p_{0,7}' 'p_{0,14}' }, 'Transketolase', { 'p_{0,3}' 'p_{0,16}' }
\node[modStyleDGHyperEdge, at=(v-coord-144-0)] (v-144-0) {$\mathrm{f\ 10,\ r_{2}}$};
% id = 212{ 'p_{0,9}' 'p_{0,16}' }, 'Transaldolase', { 'Ribulose-5-Phosphate' 'p_{0,32}' }
\node[modStyleDGHyperEdge, at=(v-coord-212-0)] (v-212-0) {$\mathrm{f\ 10,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-341-0)] (v-341-0) {$\mathrm{f\ 20,\ r_{2}}$};
...
% id = 144{ 'p_{0,7}' 'p_{0,14}' }, 'Transketolase', { 'p_{0,3}' 'p_{0,16}' }
\path[modStyleDGHyperConnector] (v-15-0) to (v-144-0);
\path[modStyleDGHyperConnector] (v-31-0) to (v-144-0);
\path[modStyleDGHyperConnector] (v-144-0) to (v-7-0);
\path[modStyleDGHyperConnector] (v-144-0) to (v-42-0);
