...
\input{\modInputPrefix/out/194_dg_0_11100_f_34_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-52-0)] (v-52-0) {$\mathrm{f\ 10,\ r_{2}}$};
...
\path[modStyleDGHyperConnector] (v-15-0) to (v-52-0);
\path[modStyleDGHyperConnector] (v-52-0) to (v-13-0);
\path[modStyleDGHyperConnector] (v-52-0) to (v-42-0);
