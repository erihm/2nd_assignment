...
\input{\modInputPrefix/out/055_dg_0_11100_f_31_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-67-0)] (v-67-0) {$\mathrm{f\ 30,\ r_{3}}$};
% id = 237{ 'p_{0,6}' 'p_{0,20}' }, 'Transaldolase', { 'Fructose-6-Phosphate' 'p_{0,4}' }
\node[modStyleDGHyperEdge, at=(v-coord-237-0)] (v-237-0) {$\mathrm{f\ 30,\ r_{3}}$};
