...
\input{\modInputPrefix/out/139_dg_0_11100_f_56_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-67-0)] (v-67-0) {$\mathrm{f\ 15,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-183-0)] (v-183-0) {$\mathrm{f\ 15,\ r_{2}}$};
% id = 197{ 'Fructose-6-Phosphate' 'p_{0,0}' }, 'Transketolase', { 'p_{0,5}' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-197-0)] (v-197-0) {$\mathrm{f\ 15,\ r_{2}}$};
