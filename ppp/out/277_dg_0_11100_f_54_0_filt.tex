...
\input{\modInputPrefix/out/276_dg_0_11100_f_54_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-153-0)] (v-153-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 182{ 'p_{0,8}' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-182-0)] (v-182-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 183{ 'Ribulose-5-Phosphate' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,6}' }
\node[modStyleDGHyperEdge, at=(v-coord-183-0)] (v-183-0) {$\mathrm{f\ 19,\ r_{2}}$};
