...
\input{\modInputPrefix/out/151_dg_0_11100_f_59_0_filt_coord.tex}
...
\node[modStyleDGHyperVertex, at=(v-coord-21-0)] (v-21-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/153_g_36_11311100.pdf}\\{$\mathrm{p_{0,10}}$}};
...
\node[modStyleDGHyperEdge, at=(v-coord-72-0)] (v-72-0) {$\mathrm{f\ 30,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-231-0)] (v-231-0) {$\mathrm{f\ 20,\ r_{3}}$};
% id = 299{ 'p_{0,7}' 'p_{0,19}' }, 'Aldolase', { 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-299-0)] (v-299-0) {$\mathrm{f\ 10,\ r_{4}}$};
...
% inFlow/outFlow, id = 16-0, graphName = p_{0,8}, inFlow = 0, outFlow = 30
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-16-0-IOFlow)] (v-16-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-16-0) to node[auto, swap] {$\mathrm{f\ 30}$} (v-16-0-IOFlow);
% inFlow/outFlow, id = 68-0, graphName = Fructose-6-Phosphate, inFlow = 0, outFlow = 10
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-68-0-IOFlow)] (v-68-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-68-0) to node[auto, swap] {$\mathrm{f\ 10}$} (v-68-0-IOFlow);
\end{tikzpicture}%
