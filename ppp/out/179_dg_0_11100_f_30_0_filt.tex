...
\input{\modInputPrefix/out/178_dg_0_11100_f_30_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-51-0)] (v-51-0) {$\mathrm{f\ 10,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-154-0)] (v-154-0) {$\mathrm{f\ 10,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-245-0)] (v-245-0) {$\mathrm{f\ 10,\ r_{3}}$};
...
% id = 51{ 'p_{0,2}' 'p_{0,7}' }, 'Transketolase', { 'p_{0,4}' 'p_{0,16}' }
\path[modStyleDGHyperConnector] (v-5-0) to (v-51-0);
\path[modStyleDGHyperConnector] (v-15-0) to (v-51-0);
\path[modStyleDGHyperConnector] (v-51-0) to (v-10-0);
\path[modStyleDGHyperConnector] (v-51-0) to (v-42-0);
