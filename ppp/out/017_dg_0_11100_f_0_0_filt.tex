...
\node[modStyleDGHyperVertex, at=(v-coord-2-0)] (v-2-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/006_g_3_11311100.pdf}\\{$\mathrm{p_{0,0}}$}};
% id = 4, graphName = p_{0,1}
% id = 5, graphName = p_{0,2}
% id = 7, graphName = p_{0,3}
% id = 10, graphName = p_{0,4}
% id = 11, graphName = p_{0,5}
\node[modStyleDGHyperVertex, at=(v-coord-11-0)] (v-11-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/008_g_13_11311100.pdf}\\{$\mathrm{p_{0,5}}$}};
% id = 13, graphName = p_{0,6}
\node[modStyleDGHyperVertex, at=(v-coord-13-0)] (v-13-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/010_g_17_11311100.pdf}\\{$\mathrm{p_{0,6}}$}};
% id = 15, graphName = p_{0,7}
% id = 16, graphName = p_{0,8}
% id = 18, graphName = p_{0,9}
\node[modStyleDGHyperVertex, at=(v-coord-18-0)] (v-18-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/012_g_25_11311100.pdf}\\{$\mathrm{p_{0,9}}$}};
...
\node[modStyleDGHyperVertex, at=(v-coord-44-0)] (v-44-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/014_g_83_11311100.pdf}\\{$\mathrm{p_{0,17}}$}};
% id = 57, graphName = p_{0,18}
% id = 58, graphName = p_{0,19}
% id = 63, graphName = p_{0,20}
% id = 68, graphName = Fructose-6-Phosphate
\node[modStyleDGHyperVertex, at=(v-coord-68-0)] (v-68-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/016_g_2_11311100.pdf}\\{$\mathrm{Fructose-6-Phosphate}$}};
