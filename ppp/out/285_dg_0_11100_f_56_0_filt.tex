...
\input{\modInputPrefix/out/284_dg_0_11100_f_56_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-14-0)] (v-14-0) {$\mathrm{f\ 30,\ r_{2}}$};
% id = 69{ 'p_{0,5}' 'p_{0,6}' }, 'Transaldolase', { 'Fructose-6-Phosphate' 'p_{0,19}' }
\node[modStyleDGHyperEdge, at=(v-coord-69-0)] (v-69-0) {$\mathrm{f\ 30,\ r_{3}}$};
% id = 107{ 'H2O' 'p_{0,6}' }, 'Phophohydrolase', { 'p_{0,1}' 'p_{0,4}' }
\node[modStyleDGHyperEdge, at=(v-coord-107-0)] (v-107-0) {$\mathrm{f\ 10,\ r_{5}}$};
% id = 181{ 'p_{0,5}' 'p_{0,19}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{0,0}' }
\node[modStyleDGHyperEdge, at=(v-coord-181-0)] (v-181-0) {$\mathrm{f\ 10,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-250-0)] (v-250-0) {$\mathrm{f\ 10,\ r_{4}}$};
% id = 3{ 'Ribulose-5-Phosphate' }, 'Aldose-Ketose <-', { 'p_{0,0}' }
\path[modStyleDGHyperConnector] (v-0-0) to node[auto, swap] {$\mathrm{f\ 20,\ r_{0}}$} (v-2-0);
...
% id = 250{ 'p_{0,12}' 'p_{0,19}' }, 'Aldolase', { 'p_{0,5}' }
\path[modStyleDGHyperConnector] (v-27-0) to (v-250-0);
\path[modStyleDGHyperConnector] (v-58-0) to (v-250-0);
\path[modStyleDGHyperConnector] (v-250-0) to (v-11-0);
