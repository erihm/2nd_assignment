...
\input{\modInputPrefix/out/236_dg_0_11100_f_44_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-56-0)] (v-56-0) {$\mathrm{f\ 20,\ r_{2}}$};
% id = 75{ 'Ribulose-5-Phosphate' 'p_{0,6}' }, 'Transaldolase', { 'Fructose-6-Phosphate' 'p_{0,9}' }
\node[modStyleDGHyperEdge, at=(v-coord-75-0)] (v-75-0) {$\mathrm{f\ 25,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-154-0)] (v-154-0) {$\mathrm{f\ 5,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-213-0)] (v-213-0) {$\mathrm{f\ 5,\ r_{3}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-333-0)] (v-333-0) {$\mathrm{f\ 5,\ r_{2}}$};
...
% id = 213{ 'p_{0,0}' 'p_{0,16}' }, 'Transaldolase', { 'p_{0,8}' 'p_{0,32}' }
\path[modStyleDGHyperConnector] (v-2-0) to (v-213-0);
\path[modStyleDGHyperConnector] (v-42-0) to (v-213-0);
\path[modStyleDGHyperConnector] (v-213-0) to (v-16-0);
\path[modStyleDGHyperConnector] (v-213-0) to (v-126-0);
