...
\input{\modInputPrefix/out/206_dg_0_11100_f_37_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-153-0)] (v-153-0) {$\mathrm{f\ 30,\ r_{2}}$};
% id = 172{ 'p_{0,9}' 'p_{0,18}' }, 'Transketolase', { 'p_{0,17}' 'p_{0,31}' }
\node[modStyleDGHyperEdge, at=(v-coord-172-0)] (v-172-0) {$\mathrm{f\ 10,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-329-0)] (v-329-0) {$\mathrm{f\ 10,\ r_{2}}$};
