...
\input{\modInputPrefix/out/018_dg_41_11100_f_41_0_filt_coord.tex}
...
\node[modStyleDGHyperVertex, at=(v-coord-2-0)] (v-2-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/020_g_724_11311100.pdf}\\{$\mathrm{p_{41,0}}$}};
% id = 5, graphName = p_{41,1}
\node[modStyleDGHyperVertex, at=(v-coord-5-0)] (v-5-0) {\includegraphics[scale=\modDGHyperImageScale] {\modInputPrefix/out/022_g_727_11311100.pdf}\\{$\mathrm{p_{41,1}}$}};
...
\node[modStyleDGHyperEdge, at=(v-coord-55-0)] (v-55-0) {$\mathrm{f\ 25,\ r_{2}}$};
...
% id = 55{ 'p_{41,3}' 'p_{41,10}' }, 'Transketolase', { 'Fructose-6-Phosphate' 'p_{41,9}' }
\path[modStyleDGHyperConnector] (v-8-0) to (v-55-0);
\path[modStyleDGHyperConnector] (v-28-0) to (v-55-0);
\path[modStyleDGHyperConnector] (v-55-0) to (v-21-0);
\path[modStyleDGHyperConnector] (v-55-0) to (v-27-0);
